 ...
 *
 * $Id: common.h,v 1.5 2011/05/26 12:01:58 jerry_jian Exp $
 */
...
enum{
	...
	RESTART_UPNP = 0x20,
	RESTART_QOS = 0x40,
	RESTART_WL = 0x80000, //mars 2010-10-20
	//RESTART_WL2G = 0x200000,  //2010.11 Lucifer
	//RESTART_WL5G = 0x100000,	//2010.11 Lucifer
	RESTART_SYSLOG = 0x80,
	...
	RESTART_DMS = 0x20000,
	RESTART_ALL = 0x100000,	//2011.03.28 Jerry
	RESTART_LAN = 0x200000,	//2011.04.19 Jerry
	RESTART_WAN = 0x400000,	//2011.04.19 Jerry
	RESTART_WLAN = 0x800000,	//2011.04.19 Jerry
	RESTART_PPPOE = 0x1000000,	//2011.05.25 Jerry
	RESTART_PPTP = 0x2000000,	//2011.05.25 Jerry
	RESTART_L2TP = 0x4000000	//2011.05.25 Jerry
};
...
#define ITVL_RESTART_DHCPD 3	//2011.04.19 Jerry: change value 1 to 3
#define ITVL_RESTART_UPNP 1
#define ITVL_RESTART_DMS 3
#define ITVL_RESTART_QOS 3
#define ITVL_RESTART_WL 3 //mars 2010-12 modify web ui time from 10 to 3
//#define ITVL_RESTART_WL2G 4 //2010.11 Lucifer
//#define ITVL_RESTART_WL5G 4 //2010.11 Lucifer
...
// 2008.10 magic }
#define ITVL_RESTART_ALL 20	//2011.03.28 Jerry
#define ITVL_RESTART_LAN 10	//2011.04.19 Jerry
#define ITVL_RESTART_WAN 10	//2011.04.19 Jerry
#define ITVL_RESTART_WLAN 10	//2011.04.19 Jerry
