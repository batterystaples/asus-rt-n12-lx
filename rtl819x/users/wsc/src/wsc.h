 ...
 *
 *	$Id: wsc.h,v 1.3 2011/05/11 10:41:57 jerry_jian Exp $
 */
/*================================================================*/
...
#define WEB_PID_FILENAME			("/var/run/httpd.pid")	//2011.05.11 Jerry
...
enum { CONFIG_METHOD_ETH=0x2, CONFIG_METHOD_PIN=0x4, CONFIG_METHOD_PBC=0x80 
	,CONFIG_METHOD_KEYPAD=0x100,CONFIG_METHOD_VIRTUAL_PBC=0x280
	,CONFIG_METHOD_PHYSICAL_PBC=0x480,CONFIG_METHOD_VIRTUAL_PIN=0x2008
...
enum { EV_START, EV_STOP, EV_EAP, EV_ASSOC_IND, EV_PIN_INPUT, EV_PB_PRESS, EV_PROBEREQ_IND ,EV_UN_AUTO_LOCK_DOWN=7
#ifdef CONFIG_IWPRIV_INTF
                , EV_MODE, EV_STATUS, EV_METHOD, EV_STEP, EV_OOB };
#else
        };
#endif  //ifdef CONFIG_IWPRIV_COMPATIBLE
...
enum {  NOT_USED, PROTOCOL_START, PROTOCOL_TIMEOUT, RECV_EAPOL_START, SEND_EAP_IDREQ, RECV_EAP_IDRSP, 
        SMI_VID_ERR, VENDOR_TYPE_ERR, SEND_EAP_START, SEND_M1, RECV_M1,
        SEND_M2, RECV_M2, RECV_M2D, SEND_M3, RECV_M3, SEND_M4, RECV_M4,
        SEND_M5, RECV_M5, SEND_M6, RECV_M6, SEND_M7, RECV_M7, SEND_M8, RECV_M8,
        PROC_EAP_ACK, PROTOCOL_SUCCESS, PROC_EAP_DONE, WSC_EAP_FAIL, HASH_FAIL,
        HMAC_FAIL, PWD_AUTH_FAIL, CONFIGURED, PROTOCOL_PBC_OVERLAPPING      
...
typedef struct context {
	...
	int wlan0_wsc_disabled;/* 1103 FOR_DUAL_BAND  */
	int wlan1_wsc_disabled;/* 1103 FOR_DUAL_BAND  */
	int wlan_inter_num;
