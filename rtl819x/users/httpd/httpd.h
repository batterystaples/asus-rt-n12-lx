 ...
 *
 * $Id: httpd.h,v 1.5 2011/07/08 09:15:23 emily Exp $
 */
...
struct form_handler {
	char *pattern;
	int (*formFunc)(webs_t wp, char_t *path, char_t *query)
};
extern struct form_handler form_handlers[];
extern int fwupgrade_flag;	//2011.04.14 Jerry
extern void firmware_upgrade();	//2011.04.14 Jerry
extern void release_dict();	//2011.04.22 Jerry
extern void http_logout_change_mode();	//2011.04.25 Jerry
#define LOGIN_IP_FILE		"/tmp/login_ip"		//2011.04.26 Jerry
#define LOGIN_TIMESTAMP_FILE	"/tmp/login_timestamp"	//2011.04.26 Jerry
extern void notify_sysconf(const char *event_name, int do_wait);	//2011.04.27 Jerry
#endif /* _httpd_h_ */
