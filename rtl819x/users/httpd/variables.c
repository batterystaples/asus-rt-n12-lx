...
//2007.10 James }
      ...
      {"SystemCmd", "Status", NULL, ARGV("syscmd.log",""), FALSE, FALSE},
		 ...
		 {"url_enable_x", "", validate_range, ARGV("0","1"), FALSE, RESTART_FIREWALL},	// 2007.10 James//2010.11 Lucifer
	      
		{"url_enable_x_1", "", validate_range, ARGV("0","1"), FALSE, RESTART_FIREWALL},   // jerry5 added for n56u  //2010.11 Lucifer

		{"url_date_x", "", validate_portrange, NULL, FALSE, RESTART_FIREWALL},	// 2007.10 James//2010.11 Lucifer
	    
		{"url_time_x", "", validate_portrange, NULL, FALSE, RESTART_FIREWALL},	// 2007.10 James//2010.11 Lucifer
	    
		{"url_time_x_1", "", validate_portrange, NULL, FALSE, RESTART_FIREWALL},   // jerry5 added for n56u //2010.11 Lucifer
	      ...
	      0), FALSE, FALSE},
		       ...
		       {"url_num_x", "", validate_range, ARGV("0","65535"), FALSE, RESTART_FIREWALL},	// 2007.10 James//2010.11 Lucifer
...
//2010.11 Lucifer
	...
	{"time_zone", "", validate_choice, 
      ...
      struct variable variables_DeviceSecurity11a[] = {
	      ...
	      0), FALSE, RESTART_WL},	// 2007.10 James//2010.11 Lucifer
	   	
              {"rt_macmode", "", validate_choice, ARGV(
                                                "disabled:Disable",
                                                "allow:Accept",
                                                "deny:Reject",
                                                0), FALSE, RESTART_WL},//2010.11 Lucifer
	      ...
	      0), FALSE, RESTART_WL},	// 2007.10 James//2010.11 Lucifer
		       ...
		       {"wl_macnum_x", "", validate_range, ARGV("0","65535"), FALSE, RESTART_WL},	// 2007.10 James//2010.11 Lucifer
					     
		       {"", "", validate_range, ARGV("0","65535"), FALSE, FALSE},											    
		    
		{"", "", validate_string, ARGV(""), FALSE, FALSE}, 
	     
      {"ACLList", "Group", validate_group, ARGV(variables_DeviceSecurity11a_ACLList, "64", "32", "wl_macnum_x"), FALSE, RESTART_WL},	// 2008.04 James.//2010.11 Lucifer
      {"rt_ACLList", "Group", validate_group, ARGV(variables_DeviceSecurity11a_rt_ACLList, "64", "32", "rt_macnum_x"), FALSE, RESTART_WL}, 
			//2010.11 Lucifer
      { 0, 0, 0, 0, 0, 0}
      };
      ...
      struct variable variables_WLANAuthentication11a[] = {
		...
		{"wl_radius_ipaddr", "", validate_ipaddr, NULL, FALSE, RESTART_WL},	//mars 2010-10-27
				     
		       {"wl_radius_port", "", validate_range, ARGV("0","65535"), FALSE, RESTART_WL},	//mars 2010-10-27
		    
		{"wl_radius_key", "", validate_string, ARGV("64"), FALSE, RESTART_WL},	//mars 2010-10-27
      ...
      struct variable variables_WLANConfig11b[] = {
			...
			/* n56u start */
			{"rt_ssid", validate_string, ARGV("32"), FALSE, RESTART_WL},//mars 2010-10-20
			{"rt_ssid2", "", validate_string, ARGV("32"), FALSE, RESTART_WL},//mars 2010-10-20
			{"rt_gmode", "", validate_choice, ARGV(
						"2:Auto",
						"1:b/g Mixed",
						"3:n Only",
						"4:g Only",
						"0:b Only", 0), FALSE, RESTART_WL},//mars 2010-10-27

			{"rt_channel", "", validate_wlchannel, NULL, FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_rateset", "", validate_choice, ARGV(
		   				"default:Default",
		 				"all:All",
						"12:1, 2 Mbps", 0), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_bcn", "", validate_range, ARGV("1", "65535", ""), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_dtim", "", validate_range, ARGV("1", "255", ""), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_gmode_protection", "", validate_string, ARGV(""), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_gmode_protection_x", "", validate_string, ARGV(""), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_rts", "", validate_range, ARGV("0", "2347", ""), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_frag", "", validate_range, ARGV("256", "2346", ""), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_ap_isolate", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_closed", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},//mars 2010-10-27
			/*{"rt_macmode", "", validate_choice, ARGV(	      	      
						"disabled:Disable",
						"allow:Accept",
						"deny:Reject",
			...
			{"rt_mrate", "", validate_choice, ARGV(
						...
						"11:48 Mbps",
						"12:54 Mbps",
						0), FALSE, RESTART_WL},//mars 2010-10-27
			/*
			{"rt_HT_HTC", "1", 0 },
			{"rt_HT_RDG", "1", 0 },
			{"rt_HT_LinkAdapt", "0", 0 },
			...
			{"rt_HT_RxStream", "2", 0 },
			*/
			{"rt_wsc_config_state", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},//mars 2010-10-27
//			{"rt_secret_code", "0", 0 },
			{"rt_wme", "", validate_choice, ARGV(
						"0:Disabled",
						"1:Enabled", 0), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_wme_no_ack", "", validate_choice, ARGV(
						"off:Disabled",
						"on:Enabled", 0), FALSE, RESTART_WL},	//mars 2010-10-27
//			{"rt_GreenAP", "0", 0 },
//			{"rt_IgmpSnEnable", "1", 0 },
			{"rt_auth_mode", "", validate_choice, ARGV(
						...
						"psk:WPA-PSK",
						"wpa:WPA",
						"radius:Radius with 802.1x", 0), FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_crypto", "", validate_choice, ARGV(
						"tkip:TKIP",
						"aes:AES",
						"tkip+aes:TKIP+AES", 0), FALSE, RESTART_WL},//mars 2010-10-20
			{"rt_wpa_psk", "", validate_string, ARGV("64"), FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_wpa_gtk_rekey", "", validate_range, ARGV("0", "86400", ""), FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_key", "", validate_choice, ARGV(
						"1:Key1",
						"2:Key2",
						"3:Key3",
						"4:Key4", 0), FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_key_type", "", validate_choice, ARGV(
						"0:HEX",
						"1:ASCII", 0), FALSE, RESTART_WL},//mars 2010-10-20
			{"rt_key1", "", validate_wlkey, NULL, FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_key2", "", validate_wlkey, NULL, FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_key3", "", validate_wlkey, NULL, FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_key4", "", validate_wlkey, NULL, FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_lazywds", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},
			{"rt_radius_ipaddr", "", validate_ipaddr, NULL, FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_radius_port", "", validate_ipaddr, NULL, FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_radius_key", "", validate_string, ARGV("64"), FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_radio_x", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},//mars 2010-10-26
//			{"rt_mode", "ap", 0 },
			{"rt_mode_x", "", validate_choice, ARGV(
						"0:AP Only",
						"1:WDS Only",
						"2:Hybrid", 0), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_wdsapply_x", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_wdsnum_x", "", validate_range, ARGV("0","65535"), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_wep_x", "", validate_choice, ARGV(
						"0:None",
						"1:WEP-64bits",
						"2:WEP-128bits", 0), FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_phrase_x", "", validate_string, ARGV("64"), FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_radio_date_x", "", validate_portrange, NULL, FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_radio_time_x", "", validate_portrange, NULL, FALSE, RESTART_WL},//mars 2010-10-27
			{"rt_macapply_x", "", validate_choice, ARGV(
						"Both",
						"802.11a only",
						"802.11g only", 0), FALSE, RESTART_WL},//mars 2010-10-27//2010.11 Lucifer
			{"rt_macnum_x", "", validate_range, ARGV("0","65535"), FALSE, RESTART_WL},//mars 2010-10-27//2010.11 Lucifer
			{"rt_maclist_x", "32", validate_hwaddr, NULL, FALSE, FALSE},
			{"rt_wpa_mode", "", validate_choice, ARGV(
						...
						"2:WPA2-Personal",
						"3:WPA-Enterprise",
						"4:WPA-Auto-Enterprise", 0), FALSE, RESTART_WL},//mars 2010-10-26
			{"rt_PktAggregate", "", validate_choice, ARGV(
						"0:Disable",
						"1:Enable", 0), FALSE, RESTART_WL},		//mars 2010-10-27
			...
			{"rt_HT_OpMode", "", validate_choice, ARGV(
						"0:Mixed Mode",
						"1:Green Field", 0), FALSE, RESTART_WL},	//mars 2010-10-27
			{"rt_HT_BW", "", validate_choice, ARGV(
						"0:20",
						"1:20/40", 0), FALSE, RESTART_WL},		//mars 2010-10-27
			{"rt_HT_EXTCHA", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},

			{"TxPower", "", validate_range, ARGV("0", "100"), FALSE, RESTART_WL},	//mars 2010-10-27

			{"rt_TxPower", "", validate_range, ARGV("0", "100"), FALSE, RESTART_WL},	//mars 2010-10-27

			{"wps_band", "", validate_choice, ARGV(
						"0:5GHz",
						"1:2.4GHz", 0), FALSE, RESTART_WL},//mars 2010-10-27
			/* n56u end */     
			...
			{"wl_wsc_mode", "", validate_string, ARGV("enabled","disabled"), FALSE, RESTART_WL},	//mars 2010-10-27
			{"wsc_mode", "", validate_string, ARGV("enabled","disabled"), FALSE, RESTART_WL},	//mars 2010-10-27
			{"wsc_config_state", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},	//mars 2010-10-20
			...
			{"wl_country_code", "", validate_string, NULL, FALSE, RESTART_WL},	//mars 2010-10-27
						    
			{"wl_bss_enabled", "", validate_choice, ARGV("0","1"), FALSE, RESTART_WL},    //mars 2010-10-27
			{"wl_ssid", "", validate_string, ARGV("32"), FALSE, RESTART_WL},	//mars 2010-10-20
			{"wl_ssid2", "", validate_string, ARGV("32"), FALSE, RESTART_WL},	//mars 2010-10-20
			{"", "", validate_range, ARGV("0","65535"), FALSE, FALSE},											    
		...
		{"wl_channel", "", validate_wlchannel, NULL, FALSE, RESTART_WL},	//mars 2010-10-27
			     
		 {"wl_wdsapply_x", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},	//mars 2010-10-27
			       
		 {"wl_lazywds", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},	//mars 2010-10-27
				       
		 {"wl_wdsnum_x", "", validate_range, ARGV("0","65535"), FALSE, RESTART_WL},	//mars 2010-10-27
		    	
		 {"wl_maxassoc", "", validate_range, ARGV("1","128"), FALSE, RESTART_WL},	//mars 2010-10-27

		 {"wl_bss_maxassoc", "", validate_range, ARGV("1","128"), FALSE, RESTART_WL},	//mars 2010-10-27
	    ...
	    {"wl_gmode_protection_x", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
				...
				{"wps_mode", "", validate_choice, ARGV(
						"1:PIN Method",
						"2:PBC Method", 0), FALSE, RESTART_WL}, //mars 2010-10-27
				...
				{"HT_GI", "", validate_choice, ARGV(
						"0:Long",
						"1:Auto", 0), FALSE, RESTART_WL}, //mars 2010-10-27

				{"HT_MCS", "", validate_range, ARGV("0","33"), FALSE, RESTART_WL}, //mars 2010-10-27
				...
				{"HT_EXTCHA", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL}, //mars 2010-10-27

				{"HT_TxStream", "", validate_range, ARGV("1","3"), FALSE, RESTART_WL}, //mars 2010-10-27

				{"HT_RxStream", "", validate_range, ARGV("1","3"), FALSE, RESTART_WL}, //mars 2010-10-27

				{"wl_txbf", "", validate_choice, ARGV("0:Disable", "1:Enable", 0), FALSE, RESTART_WL},//mars 2010-10-27
	      ...
	      0), FALSE, RESTART_WL},	//mars 2010-10-26
	      ...
	      0), FALSE, RESTART_WL},	//mars 2010-10-20
	   
		{"wl_wpa_psk", "", validate_string, ARGV("64"), FALSE, RESTART_WL},	//mars 2010-10-26
		...
		{"wl_phrase_x", "", validate_string, ARGV("64"), FALSE, RESTART_WL},	//mars 2010-10-27
	    
		{"wl_key1", "", validate_wlkey, NULL, FALSE, RESTART_WL},	//mars 2010-10-26
	    
		{"wl_key2", "", validate_wlkey, NULL, FALSE, RESTART_WL},	//mars 2010-10-26
	    
		{"wl_key3", "", validate_wlkey, NULL, FALSE, RESTART_WL},	//mars 2010-10-26
	    
		{"wl_key4", "", validate_wlkey, NULL, FALSE, RESTART_WL},	//mars 2010-10-26
	      ...
	      0), FALSE, RESTART_WL},	//mars 2010-10-26
				...
				{"wl_key_type", "", validate_choice, ARGV(    
						   "0:HEX",
							"1:ASCII", 0), FALSE, RESTART_WL}, //mars 2010-10-26
			
	     {"wl_wpa_gtk_rekey", "", validate_range, ARGV("0", "86400", ""), FALSE, RESTART_WL},	//mars 2010-10-26
	      ...
	      0), FALSE, RESTART_WL},	//mars 2010-10-27
			  ...
			  {"wl_nbw_cap", "", validate_choice, ARGV("0", "1", "2"), FALSE, RESTART_WL},   //mars 2010-10-27
			  
			  {"wl_txstreams", "", validate_range, ARGV("0", "1", "2"), FALSE, RESTART_WL},   //mars 2010-10-27
			  
			  {"wl_rxstreams", "", validate_range, ARGV("0", "1", "2"), FALSE, RESTART_WL},   //mars 2010-10-27
			    
		 {"wl_closed", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},	//mars 2010-10-27
			       
		 {"wl_ap_isolate", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},	//mars 2010-10-27
				 
		 {"wl_radarthrs", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
	     ...
	     {"wl_frag", "", validate_range, ARGV("256", "2346", ""), FALSE, RESTART_WL},	//mars 2010-10-27
		     
	     {"wl_rts", "", validate_range, ARGV("0", "2347", ""), FALSE, RESTART_WL},	//mars 2010-10-27
		     
	     {"wl_dtim", "", validate_range, ARGV("1", "255", ""), FALSE, RESTART_WL},	//mars 2010-10-27
		     
	     {"wl_bcn", "", validate_range, ARGV("1", "65535", ""), FALSE, RESTART_WL},	//mars 2010-10-27
		 ...
		 {"wl_radio_x", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},	//mars 2010-10-27
	      
		{"wl_radio_date_x", "", validate_portrange, NULL, FALSE, RESTART_WL},	//mars 2010-10-27
	    
		{"wl_radio_time_x", "", validate_portrange, NULL, FALSE, RESTART_WL},	//mars 2010-10-27
			 
	     {"wl_radio_power_x", "", validate_range, ARGV("1", "84", ""), FALSE, RESTART_WL},	//mars 2010-10-27
      ...
      {"WirelessLog", "Status", NULL, ARGV("wlan11b.log",""), FALSE, FALSE},
	      ...
	      {"wl_wme_bss_disable", "", validate_choice, ARGV("0", "1"), FALSE, RESTART_WL}, //mars 2010-10-27
	      ...
	      0), FALSE, RESTART_WL},	//mars 2010-10-27
		    ...
		    {"wl_wme_ap_bk", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
							 
		    {"wl_wme_ap_be", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
							 
		    {"wl_wme_ap_vi", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
							 
		    {"wl_wme_ap_vo", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
							 
		    {"wl_wme_sta_bk", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
							 
		    {"wl_wme_sta_be", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
							 
		    {"wl_wme_sta_vi", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
							 
		    {"wl_wme_sta_vo", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27

					{"wl_wme_txp_be", "", validate_string, ARGV(""), FALSE, RESTART_WL},    //mars 2010-10-27

					{"wl_wme_txp_bk", "", validate_string, ARGV(""), FALSE, RESTART_WL},    //mars 2010-10-27

					{"wl_wme_txp_vi", "", validate_string, ARGV(""), FALSE, RESTART_WL},    //mars 2010-10-27

					{"wl_wme_txp_vo", "", validate_string, ARGV(""), FALSE, RESTART_WL},    //mars 2010-10-27

		 {"wl_preauth", "", validate_range, ARGV("0","1"), FALSE, RESTART_WL},	//mars 2010-10-27
						      
		    {"wl_net_reauth", "", validate_string, ARGV(""), FALSE, RESTART_WL},	//mars 2010-10-27
...
{"wl_guest_enable", "0", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_ssid_1", "guest", 0, 0, 0, RESTART_WL},	//mars 2010-10-20
{"wl_guest_auth_mode_1", "open", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_crypto_1", "0", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_wpa_psk_1", "", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_wep_x_1", "0", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_phrase_x_1", "", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_key1_1", "", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_key2_1", "", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_key3_1", "", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_key4_1", "", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_key_1", "1", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"wl_guest_wpa_gtk_rekey_1", "0", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"lan1_ipaddr", "192.168.2.1", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
{"lan1_netmask", "255.255.255.0", 0, 0, 0, RESTART_WL},	//mars 2010-10-27
...
{"lan1_lease", "86400", 0, 0, 0, RESTART_DHCPD},	// 2007.10 James
	...
	{"RBRList", "Group", validate_group, ARGV(variables_WLANConfig11b_RBRList, "16", "32", "wl_wdsnum_x"), FALSE, RESTART_WL},	//mars 2010-10-27

	{"rt_RBRList", "Group", validate_group, ARGV(variables_WLANConfig11b_rt_RBRList, "16", "32", "rt_wdsnum_x"), FALSE, RESTART_WL},//mars 2010-10-27
	...
	{ 0, 0, 0, 0, 0, 0}
      ...
      {"ACLList", "Group", validate_group, ARGV(variables_DeviceSecurity11b_ACLList, "64", "32", "wl_macnum_x"), FALSE, RESTART_WL},	// 2008.01 James.//2010.11 Lucifer
      {"rt_ACLList", "Group", validate_group, ARGV(variables_DeviceSecurity11b_rt_ACLList, "64", "32", "rt_macnum_x"), FALSE, RESTART_WL},
     //2010.11 Lucifer
      { 0, 0, 0, 0, 0, 0}
      };
