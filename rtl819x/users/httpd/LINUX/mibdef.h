 ...
 *
 *      $Id: mibdef.h,v 1.7 2011/07/13 07:21:29 emily Exp $
 *
 */
...
MIBDEF(unsigned char, countrycode,[3],	COUNTRY_CODE,	STRING_T, HW_WLAN_SETTING_T, 0, 0)	//Edison 2011.3.25
#else /*rtl8196c*/
...
MIBDEF(unsigned long,	dhcpLease, ,	DHCP_LEASE,	DWORD_T, APMIB_T, 0, 0)	//2011.06.01 Jerry
...
MIBDEF(unsigned char,	pppoeRelayEnabled, ,	PPPOE_RELAY_ENABLED,	BYTE_T, APMIB_T, 0, 0)
...
MIBDEF(unsigned char,	ntpServerId, ,	NTP_SERVER_ID,	BYTE_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	ntpTimeZone, [8],	NTP_TIMEZONE,	STRING_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	ntpSysTimeZone, [16],	NTP_SYS_TIMEZONE,	STRING_T, APMIB_T, 0, 0)
//MIBDEF(unsigned char,	ntpServerIp1, [4],	NTP_SERVER_IP1,	IA_T, APMIB_T, 0, 0)
//MIBDEF(unsigned char,	ntpServerIp2, [4],	NTP_SERVER_IP2,	IA_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,   ntpServerIp1, [MAX_IP_LEN],      NTP_SERVER_IP1, STRING_T, APMIB_T, 0, 0)  //EMILY
MIBDEF(unsigned char,   ntpServerIp2, [MAX_IP_LEN],      NTP_SERVER_IP2, STRING_T, APMIB_T, 0, 0)
...
#ifdef HOME_GATEWAY
MIBDEF(unsigned char,	firewallEnabled, ,	FIREWALL_ENABLED,	BYTE_T, APMIB_T, 0, 0)
MIBDEF(unsigned char,	wanAccessEnabled, ,	WEB_WAN_ACCESS_ENABLED,	BYTE_T, APMIB_T, 0, 0)
MIBDEF(unsigned short,	webWanAccessPort, ,	WEB_WAN_ACCESS_PORT,	WORD_T, APMIB_T, 0, 0)	/*Edison 2011.6.2*/
...
MIBDEF(unsigned char,	rtLogServer, [MAX_IP_LEN],	REMOTELOG_SERVER,	STRING_T, APMIB_T, 0, 0)
...
MIBDEF(unsigned char,   x_Setting, , X_SETTING,    BYTE_T, APMIB_T, 0, 0)	//2011.03.14 Jerry
MIBDEF(unsigned char,   wan_ready, , WAN_READY,    BYTE_T, APMIB_T, 0, 0)	//2011.03.14 Jerry
MIBDEF(unsigned char,   w_Setting, , W_SETTING,    BYTE_T, APMIB_T, 0, 0)	//2011.04.12 Jerry
MIBDEF(unsigned char,	preferred_lang,	[16],	PREFERRED_LANG,	STRING_T, APMIB_T, 0, 0)	//2011.04.12 Jerry
MIBDEF(unsigned char,   refuse_eap, , REFUSE_EAP,    BYTE_T, APMIB_T, 0, 0)	//2011.04.20 Jerry
MIBDEF(unsigned char,	ipAddrGW, [4],	IP_ADDR_GW,	IA_T, APMIB_T, 0, 0)	//2011.04.21 Jerry
MIBDEF(unsigned char,	subnetMaskGW, [4],	SUBNET_MASK_GW,	IA_T, APMIB_T, 0, 0)	//2011.04.21 Jerry
MIBDEF(unsigned char,	dhcpGW, ,	DHCP_GW,	BYTE_T, APMIB_T, 0, 0)	//2011.04.21 Jerry
...
MIBDEF(unsigned char,   asusphrase, [65],   	ASUS_PHRASE,    STRING_T,  CONFIG_WLAN_SETTING_T, 0, 0)
//Lucifer add
