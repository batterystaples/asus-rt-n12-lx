...
#define CA4AP_CERT_FILE "/var/myca/ca4ap.cert"
#define AP_CERT_FILE "/var/myca/ap.cert"
...
#define TR069_PID_FILE "var/runcwmp.pid"
...
#define PPP_PAP_FILE "/etc/ppp/pap-secrets"
#define PPP_CHAP_FILE "/etc/ppp/chap-secrets"
#define PPP_FIRST_FILE "/etc/ppp/first"
#define PPP_FIRST_DEMAND "/etc/ppp/firstdemand"
#define PPP_FILE "/var/ppp"
#define PPP_OPTIONS_FILE "/etc/ppp/options"
...
extern int restart_lan_flag;	//2011.04.16 Jerry
extern int restart_wlan_flag;	//2011.04.18 Jerry

#define TEMP_WAN_CHECK "/var/tmp_wan_check"
#define TEMP_WAN_DHCP_INFO "/var/tmp_wan_dhcp_info"
#define DETECTWAN_PID_FILE "/var/run/detectWan.pid"	//2011.07.04 Jerry
#define DHCP_RENEW_TEMP_FILE "/tmp/dhcp_renew"		//2011.07.04 Jerry
#endif
