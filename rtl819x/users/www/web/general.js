...
function validate_string_ssid(o){
	...
	if(o.value == "")	//Modified by Jerry
		o.value = "default";
	else if(document.form.current_page.value == "Basic_GOperation_Content.asp" && o.value == "")	//Modified by Jerry
		o.value = "default";
	else if(document.form.current_page.value == "Basic_AOperation_Content.asp" && o.value == "")	//Modified by Jerry
		o.value = "default";
...
function validate_ipaddr_final(o, v){
	...
	if(v == 'dhcp_start' || v == 'dhcp_end' ||
		...
		if((wan_route_x == "IP_Bridged" && wan_nat_x == "0") || sw_mode=="1")	// variables are defined in state.js
