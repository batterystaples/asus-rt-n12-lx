  ...
  var file_obj = document.form.file;
	...
	if(file_obj.value == ""){
		...
		file_obj.focus();
					...
					file_obj.value.lastIndexOf(".dat")  < 0 || 
					file_obj.value.lastIndexOf(".dat") != (file_obj.value.length)-4){		
...
<input type="hidden" name="current_page" value="saveconf.asp">
<input type="hidden" name="next_page" value="saveconf.asp">
