...
#define WLANCFG "/etc/linuxigd/WLANConfig11b"	//Edison 2011.4.26 no use
#define PRODUCTCFG "/etc/linuxigd/general.log"	//Edison 2011.4.26 no use
#define LAN_DEV "br0"				//Edison 2011.4.26 no use
...
//---------------------------
	...
	count = fread(fw_buf, 1, 64, fp);
	fw_buf[count - 1] = '\0';
	fclose(fp);
	strncpy(firmver_g, fw_buf, sizeof(firmver_g));
