 ...
 *
 *  $Id: 8192cd_headers.h,v 1.2 2011/05/16 09:56:45 edison_shih Exp $
 *
...
EXTERN __MIPS16 struct stat_info *get_stainfo (struct rtl8192cd_priv *priv, unsigned char *hwaddr);
...
EXTERN __MIPS16 unsigned char get_hdrlen(struct rtl8192cd_priv *priv, UINT8 *pframe);
...
EXTERN void remove_2r_sta(struct rtl8192cd_priv *priv, struct stat_info *pstat);
#endif
...
EXTERN __MIPS16 void rtl_netif_rx(struct rtl8192cd_priv *priv, struct sk_buff *pskb, struct stat_info *pstat);
...
#if defined(WIFI_11N_2040_COEXIST) && defined(BANDWIDTH_SWITCH)
EXTERN void find_initialGain_Boundary(struct rtl8192cd_priv *priv);
#endif
