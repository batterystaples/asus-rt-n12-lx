 ...
 *
 *  $Id: 8192cd_psk_hapd.c,v 1.2 2011/05/16 09:57:00 edison_shih Exp $
 *
...
void psk_indicate_evt(struct rtl8192cd_priv *priv, int id, unsigned char *mac, unsigned char *msg, int len)
{
	...
	case DOT11_EVENT_REASSOCIATION_IND:
		...
		printk("_Eric psk_indicate_evt DOT11_EVENT_ASSOCIATION_IND\n");
