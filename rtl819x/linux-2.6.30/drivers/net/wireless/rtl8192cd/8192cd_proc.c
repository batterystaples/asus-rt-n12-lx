 ...
 *
 *  $Id: 8192cd_proc.c,v 1.2 2011/05/16 09:57:00 edison_shih Exp $
 *
...
//	if ((GET_CHIP_VER(priv)==VERSION_8192D) && (priv->pmib->dot11RFEntry.phyBandSelect & PHY_BAND_5G)) {
	...
	PRINT_SINGL_ARG("    deltaIQK: ", priv->pmib->dot11RFEntry.deltaIQK, "%d");
	PRINT_SINGL_ARG("    deltaLCK: ", priv->pmib->dot11RFEntry.deltaLCK, "%d");
...
#endif
	PRINT_SINGL_ARG("    bw switch triggered: ", priv->pshare->rf_ft_var.bws_triggered, "%d");
#endif
	return pos;
}
