 ...
 *
 *  $Id: 8192cd.h,v 1.2 2011/05/16 09:56:45 edison_shih Exp $
 *
...
enum led_type {
	...
	LEDTYPE_SW_LED1_GPIO10_LINKTXRX,				//14 for 92D LED Control
	LEDTYPE_SW_MAX,
};
