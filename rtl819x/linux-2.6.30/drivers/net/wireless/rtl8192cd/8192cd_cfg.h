 ...
 *
 *	 $Id: 8192cd_cfg.h,v 1.2 2011/05/16 09:56:39 edison_shih Exp $
 *
...
#ifdef __MIPSEB__
	#define _BIG_ENDIAN_
//### add by sen_liu 2011.4.14 CONFIG_NET_PCI defined before and CONFIG_PCI
...
//-------------------------------------------------------------
// Dynamic switch BW to 20/40
//-------------------------------------------------------------
#define BANDWIDTH_SWITCH
...
//-------------------------------------------------------------
#if !defined(CONFIG_RTL8196B_GW_8M) && !defined(CONCURRENT_MODE) && !defined(CONFIG_WIRELESS_LAN_MODULE)
...
#ifdef CONFIG_RTL_92D_SUPPORT
#define AGC_TAB_SIZE	6124
#define PHY_REG_SIZE	8196
#define MAC_REG_SIZE	2048
#define PHY_REG_PG_SIZE 3600
#else
