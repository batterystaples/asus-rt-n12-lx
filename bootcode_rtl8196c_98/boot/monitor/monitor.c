...
void monitor_asus(void)//Lucifer
{
	for(;;)
	{
		REG32(PIN_MUX_SEL)=REG32(PIN_MUX_SEL)|(~(0xFFFFFFFF-0x00300000));//close led
		delay_ms(2000);
		REG32(PIN_MUX_SEL)=REG32(PIN_MUX_SEL)&(0xFFFFFFFF-0x00300000);//open led
		delay_ms(2000);
